...
public class SimulatedMetricsSource : IMigrationMetricsSource
{
    ...
    public async Task<CollectionResult> GetMetricsAsync(CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            _logger.LogInformation(
                "Simulated metrics generated: Users={Users}, Groups={Groups}, Hybrid={Hybrid}, Entra={Entra}, Duration={DurationMs}ms",
                metrics.SyncedUsers, metrics.SyncedGroups, metrics.HybridDevices, metrics.EntraJoinedDevices, sw.ElapsedMilliseconds);
    ...
    private MigrationMetrics GenerateMetrics()
    {
        ...
        var metrics = new MigrationMetrics
        {
            ...
            SyncedUsers = Math.Max(TargetSyncedUsers, (int)(_lastMetrics.SyncedUsers * changeMultiplier * variance)),
            SyncedGroups = Math.Max(TargetSyncedGroups, (int)(_lastMetrics.SyncedGroups * changeMultiplier * variance)),
